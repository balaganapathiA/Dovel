        ...
        <section className="bg-white py-20 px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-20">
              ...
              <div className="text-center p-6  rounded-lg">
                <p className="text-4xl font-bold text-teal-600 mb-2">180K</p>
            ...
            <div className="text-center">
              <h3 className="text-xl font-semibold mb-8">CHOOSE PLAN:</h3>
              <div className="flex flex-col md:flex-row justify-center gap-6 max-w-2xl mx-auto">
                ...
                <h4 className="text-2xl font-bold text-[#2a8e9e] ">Plus</h4>
          <div className="flex items-baseline justify-between gap-2 mt-2 mb-4">
            <span className="relative top-12 text-xl font-sans text-[#2a8e9e] ">£2.99/month</span>
          ...
          <div className="flex items-baseline justify-between gap-2 mt-2 mb-4">
            <span className="relative top-12 text-xl font-sans text-[#E9F3F4] ">£2.99/month</span>
